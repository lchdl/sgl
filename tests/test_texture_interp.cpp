...
void init_render() {
  /* setup resources */
  textures.checker = sgl::load_texture("assets/common/textures/checker_5x5.png", PixelFormat_BGRA8888, TextureSampling_Nearest, true);
  textures.target = sgl::create_texture(w, h, PixelFormat_BGRA8888, TextureSampling_Nearest, TextureUsage_ColorComponents);

  /* initialize render pipeline */
  renderer.bind_render_target(&textures.target);
