...
void init_render() {
  ...
  chess = sgl::load_texture("assets/common/textures/chess.png", PixelFormat_BGRA8888, TextureSampling_Nearest);
  chess_mask = sgl::load_texture("assets/common/textures/chess_mask.png", PixelFormat_UInt8, TextureSampling_Nearest);
}
